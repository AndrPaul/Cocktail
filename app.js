...
class getRecipe {
  ...
  recipeUI(obj) {
    ...
    rowRecipe.innerHTML += `<div class ="sideCard col-lg-4 col-md-6 col-sm-12">
            ...
            <p id="obj1" class="ingredients"> ${obj.strIngredient1} <span>${obj.strMeasure1 === null? '': obj.strMeasure1}</span></p>
            <p id="obj2" class="ingredients"> ${obj.strIngredient2} <span>${obj.strMeasure2 === null? '': obj.strMeasure2}</span></p>
            <p id="obj3" class="ingredients"> ${obj.strIngredient3} <span>${obj.strMeasure3 === null? '': obj.strMeasure3}</span></p>
            <p id="obj4" class="ingredients"> ${obj.strIngredient4} <span>${obj.strMeasure4 === null? '': obj.strMeasure4}</span></p>
            <p id="obj5" class="ingredients"> ${obj.strIngredient5} <span>${obj.strMeasure5 === null? '': obj.strMeasure5}</span></p>
            <p id="obj6" class="ingredients"> ${obj.strIngredient6} <span>${obj.strMeasure6 === null? '': obj.strMeasure6}</span></p>
            <p id="obj7" class="ingredients"> ${obj.strIngredient7} <span>${obj.strMeasure7 === null? '': obj.strMeasure7}</span></p>
            <p id="obj8" class="ingredients"> ${obj.strIngredient8} <span>${obj.strMeasure8 === null? '': obj.strMeasure8}</span></p>
            <p id="obj9" class="ingredients"> ${obj.strIngredient9} <span>${obj.strMeasure9 === null? '': obj.strMeasure9}</span></p>
            <p id="obj10" class="ingredients"> ${obj.strIngredient10} <span>${obj.strMeasure10 === null? '': obj.strMeasure10}</span></p>
